...
const { Coupon, CouponUsage, Order, User, Store } = require('../models');
...
class CouponService {
  ...
  async getCouponStats(couponId) {
    ...
    return {
      coupon_id: couponId,
      code: coupon.code,
      total_uses: parseInt(usages[0].total_uses) || 0,
      total_discount: parseFloat(usages[0].total_discount) || 0,
      total_sales: parseFloat(usages[0].total_sales) || 0,
